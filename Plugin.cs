...
namespace Hanshek
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Hanshek";
        public static string heroName = characterName;

        public static string subclassName = "Royalmage"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Hanshek, the Royalmage.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Hanshek",
                _contentFolder: "Hanshek",
